...
*/
var aa=__webpack_require__(0),m=__webpack_require__(4),q=__webpack_require__(15);function t(a){for(var b=a.message,c="https://reactjs.org/docs/error-decoder.html?invariant="+b,d=1;d<arguments.length;d++)c+="&args[]="+encodeURIComponent(arguments[d]);a.message="Minified React error #"+b+"; visit "+c+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings. ";return a}if(!aa)throw t(Error(227));var ba=null,ca={};
...
// EXTERNAL MODULE: ./src/components/card-list/card-list.syles.css
var card_list_syles = __webpack_require__(20);

// EXTERNAL MODULE: ./src/components/card/card.styles.css
var card_styles = __webpack_require__(21);

// CONCATENATED MODULE: ./src/components/card/card.component.js


var card_component_Card = function Card(props) {
  ...
  }, react_default.a.createElement("h1", null, props.user.name), react_default.a.createElement("p", null, props.user.email)));
};
// CONCATENATED MODULE: ./src/components/card-list/card-list.component.js



var card_list_component_CardList = function CardList(props) {
  return react_default.a.createElement("div", {
    className: "card-list"
  }, props.users.map(function (user) {
    return react_default.a.createElement(card_component_Card, {
      key: user.id,
      user: user
    });
  }));
};
// CONCATENATED MODULE: ./src/helpers/dummy_data.js
var userData = [{
  id: 1,
  name: {
    first: "Jon",
  ...
  picture: {
    medium: "../public/images/avatar.jpg"
  }
}, {
  id: 2,
  name: {
  ...
  email: "cersei.lanister@gameofthrones.com",
  picture: {
    medium: "../public/images/avatar.jpg"
  }
}];
// CONCATENATED MODULE: ./src/helpers/func.js

var filterUserData = function filterUserData(users) {
...
var src_App = __webpack_require__(22);

// EXTERNAL MODULE: ./src/components/search-box/search-box.styles.css
var search_box_styles = __webpack_require__(23);

// CONCATENATED MODULE: ./src/components/search-box/search-box.component.js


var search_box_component_SearchBox = function SearchBox(_ref) {
  ...
  createClass_default()(App, [{
    ...
    value: function render() {
      ...
      return react_default.a.createElement("div", {
        ...
        className: "face-cards"
      }, "Face Cards"), react_default.a.createElement(search_box_component_SearchBox, {
        placeholder: "search the faces",
        handleChange: this.handleChange
      }), react_default.a.createElement(card_list_component_CardList, {
        users: filteredUsers
      }));
    }
  }]);
